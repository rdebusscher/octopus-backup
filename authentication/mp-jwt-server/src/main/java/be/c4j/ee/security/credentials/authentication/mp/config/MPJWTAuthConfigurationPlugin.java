...
import be.c4j.ee.security.credentials.authentication.mp.filter.MPUserFilter;
...
@ApplicationScoped
@PluginOrder(75)
public class MPJWTAuthConfigurationPlugin implements ConfigurationPlugin {

    @Override
    public void addConfiguration(Ini ini) {
        Ini.Section mainSection = ini.get(IniSecurityManagerFactory.MAIN_SECTION_NAME);

        mainSection.put("mpUser", MPUserFilter.class.getName());
