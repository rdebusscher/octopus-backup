 ...
 */
@ApplicationScoped
public class OctopusOAuth2ServiceProducer extends OAuth2ServiceProducer {
    ...
    public OAuth20Service createOAuthService(HttpServletRequest req, String csrfToken) {
        ...
        ServiceBuilder serviceBuilder = builder
                ...
                .scope("openid email " + configuration.getOAuth2Scopes())
                .debug();
        if (csrfToken != null && !csrfToken.isEmpty()) {
            serviceBuilder.state(csrfToken);
        }

        return serviceBuilder.build(OctopusApi20.instance());
    }
