...
public class OctopusInterceptor_ClassLevelSystemAccountTest extends OctopusInterceptorTest {
    ...
    public OctopusInterceptor_ClassLevelSystemAccountTest(boolean authenticated, String permission, boolean customAccess, String shiroPermission, String systemAccount, String role) {
