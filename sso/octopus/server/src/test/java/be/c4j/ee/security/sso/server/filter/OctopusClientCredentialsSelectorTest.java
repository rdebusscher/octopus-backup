...
public class OctopusClientCredentialsSelectorTest {
    ...
    public void selectClientSecrets() throws JOSEException, InvalidClientException, URISyntaxException {
        ...
        Secret secret = new Secret(new String(clientSecret, Charset.forName("UTF-8")));
        ...
        ClientAuthenticationVerifier<Object> authenticationVerifier = new ClientAuthenticationVerifier<Object>(credentialsSelector, expectedAudience);
