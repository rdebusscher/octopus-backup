...
public class LogoutServlet extends HttpServlet {
    ...
    // These is generated by RequestScoped producer and thus proxy injected here.
    @Inject
    ...
    private boolean validRequest(SignedJWT idTokenHint) {
        ...
        try {
            ...
            // No Exception to throw, MACVerifier failed
            return false;
        } catch (java.text.ParseException e) {
            // No Exception to throw, BASE64Decode failed
            return false;
        }
    }
