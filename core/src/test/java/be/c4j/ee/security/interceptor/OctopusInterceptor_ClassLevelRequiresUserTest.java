...
public class OctopusInterceptor_ClassLevelRequiresUserTest extends OctopusInterceptorTest {
    ...
    public OctopusInterceptor_ClassLevelRequiresUserTest(boolean authenticated, String permission, boolean customAccess, String shiroPermission, String systemAccount, String role) {
