 ...
 *
 */
@OctopusPermissions("permission1")
public class ClassLevelOctopusPermission {

    public static final String CLASS_LEVEL_OCTOPUS_PERMISSION = "ClassLevel#octopusPermission";
