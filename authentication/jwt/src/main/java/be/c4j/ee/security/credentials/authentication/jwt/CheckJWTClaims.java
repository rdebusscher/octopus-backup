...
public interface CheckJWTClaims {
    ...
    /**
     * Should verify if the custom requirements of your security restrictions are met. Should throw ClaimCredentialsException when there is an issue with the JWT token.
     *
     * @param request
     * @param headerParams
     * @param claims
