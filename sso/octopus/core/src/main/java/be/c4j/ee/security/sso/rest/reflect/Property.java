 ...
 */
/*
 * WITH SOME SMALL ADDITIONS and removed support fo cglib.
 */
...
import static be.c4j.ee.security.sso.rest.reflect.Bean.*;
...
public final class Property implements AnnotatedElement {
    ...
    public static boolean isBasicPropertyType(Serializable value) {
        ...
        return isBasicPropertyType(value.getClass());
    }
     ...
     * @return
     */
    public static boolean isBasicPropertyType(Class<?> classType) {
