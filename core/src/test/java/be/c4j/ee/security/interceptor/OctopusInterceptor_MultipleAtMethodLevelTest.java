...
public class OctopusInterceptor_MultipleAtMethodLevelTest extends OctopusInterceptorTest {
    ...
    public OctopusInterceptor_MultipleAtMethodLevelTest(boolean authenticated, String permission, boolean customAccess, String shiroPermission, String systemAccount, String role) {
