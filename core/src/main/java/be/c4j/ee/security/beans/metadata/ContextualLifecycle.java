...
package be.c4j.ee.security.beans.metadata;
 ...
 * Callbacks used by {@link be.c4j.ee.security.beans.BeanBuilder} to allow control
...
public interface ContextualLifecycle<T> {
     ...
     * {@link javax.enterprise.inject.spi.Bean#create(javax.enterprise.context.spi.CreationalContext)} is called.
     *
    ...
    /**
     * Callback invoked by a Solder created bean when
     * {@link javax.enterprise.inject.spi.Bean#destroy(Object, javax.enterprise.context.spi.CreationalContext)} is
     * called.
     *
     * @param bean              the bean initiating the callback
