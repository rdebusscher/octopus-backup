 ...
 *
 */
public class OctopusOAuth2CallbackProcessor extends OAuth2CallbackProcessor {
    ...
    public void processCallback(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if ((null != error) && ("access_denied".equals(error.trim()))) {
            logger.warn("Octopus informs us that no valid credentials are supplied or that consent is not given");
