 ...
 * <p>
 * A base class for implementing {@link javax.enterprise.inject.spi.Bean}. The attributes are immutable, and
...
public abstract class BaseImmutableBean<T> implements Bean<T> {
     ...
     */
    public BaseImmutableBean(Class<?> beanClass, String name, Set<Annotation> qualifiers,
