...
public class ImmutableBean<T> extends BaseImmutableBean<T>
{
     ...
     */
    // CHECKSTYLE:OFF
    public ImmutableBean(Class<?> beanClass, String name, Set<Annotation> qualifiers, Class<? extends Annotation>
            scope, Set<Class<? extends Annotation>> stereotypes, Set<Type> types, boolean alternative,
