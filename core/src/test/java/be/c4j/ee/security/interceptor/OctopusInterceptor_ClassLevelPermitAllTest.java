...
public class OctopusInterceptor_ClassLevelPermitAllTest extends OctopusInterceptorTest {
    ...
    public OctopusInterceptor_ClassLevelPermitAllTest(boolean authenticated, String permission, boolean customAccess, String shiroPermission, String systemAccount, String role) {
