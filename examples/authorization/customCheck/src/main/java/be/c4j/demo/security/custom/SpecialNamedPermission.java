...
public class SpecialNamedPermission extends NamedDomainPermission {
    ...
    public SpecialNamedPermission(String someName, String wildcardString, MyCheckInfo myCheckInfo, List<Long> partitions) {
        ...
        if (partitions != null) {
            ...
            this.partitions = Collections.unmodifiableList(Collections.<Long>emptyList());  // Security mesure, make it unmodifiable so that a CustomerVoter for example can't change it.
