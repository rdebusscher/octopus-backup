...
public class OctopusAnnotationContainerRequestFilter implements ContainerRequestFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        boolean skip = AnnotationUtil.hasAnnotation(info.getMethodAnnotations(), IgnoreOctopusMPRestFilter.class)
                || AnnotationUtil.hasAnnotation(info.getClassAnnotations(), IgnoreOctopusMPRestFilter.class);
