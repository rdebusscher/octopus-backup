...
public class OctopusInterceptor_ClassLevelCustomVoterTest extends OctopusInterceptorTest {
    ...
    public OctopusInterceptor_ClassLevelCustomVoterTest(boolean authenticated, String permission, boolean customAccess, String shiroPermission, String systemAccount, String role) {
    ...
    public static List<Object[]> defineScenarios() {
        return Arrays.asList(new Object[][]{
                ...
                {AUTHENTICATED, null, NO_CUSTOM_ACCESS, null, null, ROLE1},          //6
        });
    }
