...
public class InMemoryDatabase {
    ...
    public static HRAppPermission createPermissionAll() {
        return new HRAppPermission("ALL", "*:*:*");
    }

    public static HRAppPermission createPermissionDepartmentSalaryAll() {
        return new HRAppPermission("DEPARTMENT_SALARY_ALL", "Department:Salary:All");
    }

    public static HRAppPermission createPermissionDepartmentSalaryManager() {
        return new HRAppPermission("DEPARTMENT_SALARY_MANAGER", "Department:Salary:Manager");
    }

    public static HRAppPermission createPermissionEmployeeReadAll() {
        return new HRAppPermission("EMPLOYEE_READ_ALL", "Employee:Read:All");
    }

    public static HRAppPermission createPermissionEmployeeUpdateSalary() {
        return new HRAppPermission("EMPLOYEE_UPDATE_SALARY", "Employee:Update:Salary");
    }

    public static HRAppPermission createPermissionDepartmentCreate() {
    ...
    private String getPermissionInfo(Principal principal) {
        ...
        for (HRAppPermission permission : permissions) {
            ...
            result.append(permission.getPermission());
        }
