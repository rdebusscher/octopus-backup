 ...
 *
 */
public class MultipleAtMethodLevel {

    public static final String MULTIPLE_CHECKS = "MultipleAtMethodLevel#multiple";

    @OnlyDuringAuthentication
    @TestPermissionCheck(TestPermission.PERMISSION1)
    public void multiple() {
        CallFeedbackCollector.addCallFeedback(MULTIPLE_CHECKS);
    }
