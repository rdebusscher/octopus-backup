 ...
 */
package be.c4j.ee.security.credentials.authentication.oauth2.octopus;
...
import be.c4j.ee.security.credentials.authentication.oauth2.octopus.filter.OctopusAuthcFilter;
import be.c4j.ee.security.credentials.authentication.oauth2.octopus.servlet.OctopusOAuth2CallbackProcessor;
 ...
 */
@ApplicationScoped
public class OctopusProviderMetaData implements OAuth2ProviderMetaData {
    ...
    public Class<? extends OAuth2CallbackProcessor> getCallbackProcessor() {
        return OctopusOAuth2CallbackProcessor.class;
    }

    @Override
    public Class<? extends AbstractOAuth2AuthcFilter> getOAuth2AuthcFilter() {
        return OctopusAuthcFilter.class;
    }
}
