...
import be.c4j.ee.security.credentials.authentication.jwt.filter.JWTAuthenticatingFilter;
...
@ApplicationScoped
@PluginOrder(75)
public class JWTConfiguration implements ConfigurationPlugin {
    @Override
    public void addConfiguration(Ini ini) {
        Ini.Section mainSection = ini.get(IniSecurityManagerFactory.MAIN_SECTION_NAME);
        mainSection.put("jwt", JWTAuthenticatingFilter.class.getName());
    }
}
